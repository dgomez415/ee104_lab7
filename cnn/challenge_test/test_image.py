...
print('Actual: This image is a cat')
####
# get the image from the internet
...
# show prediction result.
print('\nPrediction: This image most likely belongs to ' + class_names[int(result.argmax(axis=-1))])
print('Actual: This image is an airplane')
...
# show prediction result.
print('\nPrediction: This image most likely belongs to ' + class_names[int(result.argmax(axis=-1))])
print('Actual: This image is an automobile')
...
# show prediction result.
print('\nPrediction: This image most likely belongs to ' + class_names[int(result.argmax(axis=-1))])
print('Actual: This image is a ship')
...
# show prediction result.
print('\nPrediction: This image most likely belongs to ' + class_names[int(result.argmax(axis=-1))])
print('Actual: This image is a deer')
